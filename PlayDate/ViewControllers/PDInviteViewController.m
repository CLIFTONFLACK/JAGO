...
//
    ...
    if ([MFMailComposeViewController canSendMail])
    {
        ...
        [mailer setSubject:@"Fast Playdate Planning from JAGO."];
        [mailer setToRecipients:@[@"abc@gmail.com"]];
        [mailer setMessageBody:@"<html><body>Check out Playdate by JAGO for the fastest and simplest way to schedule kids playdates <a href='http://www.jago.nu'>www.jago.nu .</a></body></html>" isHTML:YES];
...
//    [self.navigationController pushViewController:pdSMSViewController animated:YES];
    ...
    if ([MFMessageComposeViewController canSendText])
    {
        ...
        NSString *message = @"Fast Playdate Planning from JAGO. Check out Playdate by JAGO for the fastest and simplest way to schedule kids playdates http://www.jago.nu";
