...
//    
    ...
    self.tblItems = @[@{TITLE: ARRANGE,  IMAGE: [UIImage imageNamed:@"add_icon"]},
                      @{TITLE: ADD_CHILD,IMAGE: [UIImage imageNamed:@"child_icon"]},
                      @{TITLE: SETS,     IMAGE: [UIImage imageNamed:@"sets_icon"]},
                      @{TITLE: FRIENDS,  IMAGE: [UIImage imageNamed:@"friend"]},
                       @{TITLE: UPGRADE,  IMAGE: [UIImage imageNamed:@"upgrade_icon"]},
...
-(void)tapGestureActioniVProfile :(UITapGestureRecognizer *)gestureView
{
    ...
    profileViewController.strCheckId = @"ParentId";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
//        UIView *viewPopup = [[UIView alloc] initWithFrame:CGRectMake(50, 100, 220, 300)];
//        viewPopup.backgroundColor = [UIColor blackColor];
//        [[PDAppDelegate sharedDelegate]popUP];
            NSString *textToShare = @"Fast Playdate Planning from JAGO.\nCheck out Playdate by JAGO for the fastest and simplest way to schedule kids playdates\n";
            NSURL *myWebsite = [NSURL URLWithString:@"http://www.jago.nu/"];
    
        UIImage *image = [UIImage imageNamed:@"AppIcon40x40.png"];
        
            NSArray *objectsToShare = @[textToShare,myWebsite,image];
            
            UIActivityViewController *activityVC = [[UIActivityViewController alloc] initWithActivityItems:objectsToShare applicationActivities:nil];
        [activityVC setValue:@"Fast Playdate Planning from JAGO." forKey:@"subject"];
