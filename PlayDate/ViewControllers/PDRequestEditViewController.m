...
//edit by tijender
    lblStatus.text = [[self.dictEventInfo_edit valueForKey:@"status"]uppercaseString];
    
    NSString *strStatus=[self.dictEventInfo_edit valueForKey:@"status"];
...
-(void)viewWillAppear:(BOOL)animated
{
    if (!firstClicked)
    {
        ...
        rect.origin.y =CGRectGetMaxY(alternateButton.frame)-25.0;
...
//           [datePicker showInView:self.view withType:PDPickerTypeDate withPickingBlock:^(NSString *pickedResult) {
               ...
               else
               {
                ...
                //   datePicker.startDate=date;
               //edit by tijender add [scrollView setContentSize:CGSizeMake(320, 400)];
...
-(void)textViewDidBeginEditing:(UITextView *)textView
{
    ...
    else
    {
        ...
        //edit by tijender 180 t0 320
        [scrollView setContentSize:CGSizeMake(scrollView.frame.size.width, CGRectGetMaxY(sendBtn.frame) + 320.0)];
...
-(void)Adjust_Size_height_EditInfo
{
    ...
    rect=tfLocation.frame;
    //edit by tijender
    rect.origin.y =CGRectGetMaxY(txtTemp.frame)+10;
    //rect.origin.y =CGRectGetMaxY(alternateButton.frame)+10.0;
    tfLocation.frame=rect;
