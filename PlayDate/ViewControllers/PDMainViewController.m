...
@interface PDMainViewController ()<FBLoginViewDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imgVwChild.layer.cornerRadius = cell.imgVwChild.frame.size.height / 2;
    cell.imgVwChild.clipsToBounds = YES;
    cell.imgVwFriend.layer.cornerRadius = cell.imgVwFriend.frame.size.height / 2;
    cell.imgVwFriend.clipsToBounds = YES;
    cell.imgVwParent.layer.cornerRadius = cell.imgVwParent.frame.size.height / 2;
    cell.imgVwParent.clipsToBounds = YES;
...
-(IBAction)btnArrangePlaydateAction:(id)sender
{
    PDRequestArrangeViewController *arrangeViewController = [[PDRequestArrangeViewController alloc]initWithNibName:@"PDRequestArrangeViewController" bundle:nil];
    [self.navigationController pushViewController:arrangeViewController animated:NO];
